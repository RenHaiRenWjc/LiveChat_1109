...
import 'package:com.jc.livechat/tim_ui_kit/ui/utils/screen_shot.dart';
...
import 'package:com.jc.livechat/tim_ui_kit/ui/widgets/drag_widget.dart';
    ...
    final List<DesktopControlBarItem> itemsList = [
      if (config.showStickerPanel)
        DesktopControlBarItem(
            ...
            imgPath: "images/tim_kit/tim_kit/svg/send_face.png"),
      if (config.showScreenshotButton && PlatformUtils().isDesktop)
        DesktopControlBarItem(
            ...
            svgPath: "images/tim_kit/tim_kit/svg/send_screenshot.svg"),
      if (config.showSendFileButton)
        DesktopControlBarItem(
            ...
            svgPath: "images/tim_kit/tim_kit/svg/send_file.svg"),
      if (config.showSendImageButton)
        DesktopControlBarItem(
            ...
            svgPath: "images/tim_kit/tim_kit/svg/send_image.svg"),
