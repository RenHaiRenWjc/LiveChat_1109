...
import 'package:com.jc.livechat/tim_ui_kit/ui/views/TIMUIKitChat/TIMUIKitMessageItem/TIMUIKitMessageReaction/tim_uikit_message_reaction_select_emoji.dart';
...
import 'package:com.jc.livechat/tim_ui_kit/ui/views/TIMUIKitChat/TIMUIKItMessageList/tim_uikit_chat_history_message_list_item.dart';
    ...
    final List<MessageToolTipItem> defaultTipsList = [
      if (fileBeenDownloaded)
        MessageToolTipItem(
            label: TIM_t("打开"),
            id: "open",
            iconImageAsset: "images/tim_kit/open_in_new.png",
      ...
      if (fileBeenDownloaded && PlatformUtils().isDesktop)
        MessageToolTipItem(
            ...
            id: "finder",
            iconImageAsset: "images/tim_kit/folder_open.png",
            onClick: () => _onTap("finder", model)),
      if (messageCanCopy)
        MessageToolTipItem(
            label: TIM_t("复制"),
            id: "copyMessage",
            iconImageAsset: "images/tim_kit/copy_message.png",
            onClick: () => _onTap("copyMessage", model)),
      if (shouldShowForwardAction && !isVoteMessage(widget.message))
        MessageToolTipItem(
            label: TIM_t("转发"),
            id: "forwardMessage",
            iconImageAsset: "images/tim_kit/forward_message.png",
            onClick: () => _onTap("forwardMessage", model)),
      if (shouldShowReplyAction)
        MessageToolTipItem(
            label: TIM_t(model.chatConfig.isAtWhenReply ? "回复" : "引用"),
            id: "replyMessage",
            iconImageAsset: "images/tim_kit/reply_message.png",
            onClick: () => _onTap("replyMessage", model)),
      MessageToolTipItem(
          label: TIM_t("多选"),
          id: "multiSelect",
          iconImageAsset: "images/tim_kit/multi_message.png",
          onClick: () => _onTap("multiSelect", model)),
      MessageToolTipItem(
          label: TIM_t("翻译"),
          id: "translate",
          iconImageAsset: "images/tim_kit/translate.png",
          onClick: () => _onTap("translate", model)),
      MessageToolTipItem(
          label: TIM_t("删除"),
          id: "delete",
          iconImageAsset: "images/tim_kit/delete_message.png",
          onClick: () => _onTap("delete", model)),
      if (shouldShowRevokeAction)
        MessageToolTipItem(
            label: TIM_t("撤回"),
            id: "revoke",
            iconImageAsset: "images/tim_kit/revoke_message.png",
